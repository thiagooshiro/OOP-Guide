...
// Mock data
const mockProducts = [
  { id: 1, name: "Camiseta", price: "R$ 49,90", image: "https://picsum.photos/200/150?random=1", category: "roupa" },
  { id: 2, name: "Caneca", price: "R$ 29,90", image: "https://picsum.photos/200/150?random=2", category: "casa" },
  { id: 3, name: "Boné", price: "R$ 39,90", image: "https://picsum.photos/200/150?random=3", category: "acessório" },
  { id: 4, name: "Caderno", price: "R$ 19,90", image: "https://picsum.photos/200/150?random=4", category: "papelaria" }
];
...
/*
try {
  const highlighted = new HighlightedCard(mockProducts[0], (product) => {
    if (modal) modal.open(product);
  });
  contentArea.prepend(highlighted.getView());
